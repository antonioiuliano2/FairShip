...
void NuTauMudet::ConstructGeometry()
{
  ...
  if(fDesign==3)
    {
      Int_t nr = 1E4;
      TGeoBBox *LargedetBox = new TGeoBBox("LargedetBox", fTagX/2, fTagY/2, (2*fZFe+3*fZRpc)/2);  
      TGeoBBox *SmalldetBox = new TGeoBBox("SmalldetBox", fXtot/2, fYtot/2, fZtot/2); //solving overlapping with pillars->dividing box to an union of two different boxes
     ...
     TGeoBBox *IronLayer1 = new TGeoBBox("Iron",fXFe/2, fYFe/2, fZFe/2);
