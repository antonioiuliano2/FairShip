...
xsec = "Nu_splines.xml" #renamed from NuCCDis_splines.xml
...
def makeEvents(nevents = 100, nutype = x, evtype = "CharmCCDIS"):

 splines   = os.path.abspath('..')+'/Nu_splines.xml'
 ...
 for p in pDict:
  ...
  #cmd = "gevgen -n "+str(N)+"  -p "+str(nutype)+" -t 1000822040[0.014],1000822060[0.241],1000822070[0.221],1000822080[0.524] -e  0.5,350"+" -f "+neutrinos+","+pDict[p]+ " --cross-sections "+splines+" --message-thresholds $GENIE/config/Messenger_laconic.xml"
