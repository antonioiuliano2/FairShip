...
TString PrepareBooleanOperation(TGeoVolumeAssembly* TargetVolume, TGeoVolume * SensitiveVolume, const int nlayers, const char *sensname, const char* shieldname, Double_t dzshield, Double_t sensdz, Double_t passdz, Int_t nlayersoffset =0){
    ...
    for (int ilayer = 0; ilayer < nlayers; ilayer++){
        ...
        TargetVolume->AddNode(SensitiveVolume,ilayer + nlayersoffset,cutT);
    }
    BooleanUnionShapes += ")";
